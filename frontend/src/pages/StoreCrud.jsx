    ...
    <>
    <Header/>
        <div className='  flex flex-col  w-[98vw] mx-[5vw]'>
            <div className='flex justify-center '>
                    <h1 className='text-md font-semibold border-b md:my-[5vh] md:w-[85vw] '>CRUD de Tiendas</h1>
            </div>

        
                    <table className='bg-[#F6F6F6] rounded-md md:w-[90vw]'>
                        <tr>
                            ...
                            <th className='text-[#ACACAC] font-semibold'>Simbolos</th>
                        </tr>
                            ...
                            data ? (
                                data.map(( producto, index)=>(
                                    <tr className='border-b'>
                                        <td className='md:px-[5vw]  md:w-[20vw]'>{producto.tienda}</td>
                                        <td className='md:w-[40vw] text-justify text-xs md:py-[2vh]'>{producto.descripcion}</td>
                                        <td className='md:px-[5vw]'>{producto.propietario}</td>
                                        <td className='md:px-[5vw]'>{producto.contacto}</td>
                                        <td className=' flex justify-between md:py-[8.4vh]'>
