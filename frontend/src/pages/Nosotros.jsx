       ...
       <div className='flex justify-between  flex-col md:flex-row gap-4 md:gap-8'>
        ...
        <div className= {` ${darkMode ? 'bg-darkSidebar' : 'bg-colorBanner'} rounded-md w-full md:w-1/2 h-40 md:h-60`}>
            ...
            <div className={` ${darkMode ? 'bg-darkSidebar' : 'bg-white border-gray-300 border'} w-full md:w-[50vw]  rounded-md  md:p-[4vh] shadow-lg  `}>
                ...
                <p className='w-full p-5 text-justify'>Convertirnos en la plataforma principal para la promoción de productos de las microempresas de comunidades rurales del Estado de Quintana Roo. Nos esforzamos por facilitar el acceso a los compradores tanto locales como internacionales, contribuyendo al crecimiento económico sostenible de estas microempresas. </p>
            </div>
