...
function CardsVendedor(prop) {
    const {darkMode, trigger, setTrigger, userId} = useGeneralContext();
                ...
                data.map((producto, index)=>(
                    <div className="flex flex-col bg-red-200">
                        ...
                        <div className={` ${darkMode ? 'bg-darkCardBottom text-white' : 'bg-cardBottom'  }   w-[11vw] h-[15vh] `}>
                            ...
                            {
                                userId == producto.id_propietario ? (
                                <>
                                    <div className={` ${darkMode ? 'bg-darkEdit' : 'bg-colorEdit' }  w-[2vw] h-[4vh] flex items-center justify-center rounded-md`}>
                                        <Link to={`/producto/${producto.id}/edit`}>
                                    ...
                                    <div className={` ${darkMode ? 'bg-darkDelete' : 'bg-deleteColor' }  w-[2vw] h-[4vh] flex items-center justify-center rounded-md`}>
