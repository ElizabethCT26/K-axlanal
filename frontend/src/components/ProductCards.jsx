                                        ...
                                        <h3 className={`${product.id_estado == 1 && 'text-red-500'} text-[#2374AB] text-md p-[2%] px-[5%] font-normal  max-w-[40vw] md:max-w-[10vw] `}>
                                            ...
                                            <div className="flex flex-wrap gap-[.3vw] items-center mx-[.2vw]" onClick={(e) => e.stopPropagation()}>
                                            {
                                                ...
                                                <a
                                                    ...
                                                    target="_blank"
                                                    className="bg-[#4fcc5d] w-[6vw] md:w-[2vw]  h-[2vh] md:h-[3vh]  rounded-md flex justify-center items-center"
                                                    
                                                >
                                                    <svg width="60%" height="100%" viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" >
