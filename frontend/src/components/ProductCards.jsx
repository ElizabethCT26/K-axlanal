    ...
    return (
      <div className='min-h-screen font-light   '>
        <div className="flex  flex-row justify-center  my-[3%] ">
            ...
            <div className="flex flex-col border  ">
                <div className="flex justify-between">
                    <h1 className="border-b-[#341CA7] border-b px-[5%]  w-[40vw]">Seleccion especial - Verano fresco!!!</h1>
                    <div >
                        <h4>❤️</h4>
                    </div>
                </div>
                ...
                <div className="flex justify-end relative ">
                        <h2 className="text-[#2374AB] border-b-[#70C5BB] border-b  px-[2%]">$500</h2>
        ...
        <div className="flex justify-center">
            <h1 className="border-b border-b-[#341CA7] mb-[1%]">Productos Relacionados</h1>
        </div>
       <div className="">
       <div className="flex justify-center ">
